...
[![Release](https://github.com/mbpfws/spec-kit/actions/workflows/release.yml/badge.svg)](https://github.com/mbpfws/spec-kit/actions/workflows/release.yml)
...
```bash
uv tool install specify-cli --from git+https://github.com/mbpfws/spec-kit.git
```
...
For support, please open a [GitHub issue](https://github.com/mbpfws/spec-kit/issues/new). We welcome bug reports, feature requests, and questions about using Spec-Driven Development.
